...
const SideNav = ({ }) => {
  ...
  return (
    <div className='hidden sm:flex flex-col justify-between grad-to-bottom text-white max-h-screen overflow-scroll lg:h-screen min-w-[240px] w-60 pb-4 overflow-hidden'>
        <div>
